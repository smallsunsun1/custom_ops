...
REGISTER_OP("DeformablePsroiPool")
    ...
    .SetShapeFn([](InferenceContext *ctx) {
      ...
      ctx->set_output(0, ctx->MakeShape({batch, output_dim_handle, pooled_size_handle, pooled_size_handle}));
      ctx->set_output(1, ctx->MakeShape({batch, output_dim_handle, pooled_size_handle, pooled_size_handle}));
      return Status::OK();
    })
